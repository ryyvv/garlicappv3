//cdn.weatherapi.com/weather/64x64/day/116.png//import axios from 'axios';
                ...
                <ScrollView>
                    <View style={styles.container}>
                                ...
                                <View style={{ marginBottom: 40 }}>
                                    ...
                                    >
                                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                            <Text style={{ fontWeight: 'bold', fontSize: 25, color: '#276653' }}>{weatherloc.name}, Ilocos Norte</Text>
                                ...
                                <View style={[styles.cardDashboard, styles.cardDashboardProp, styles.overlay]}>
                                    ...
                                    <View style={styles.div2RowSpaceEven}>
                                        <View style={{ alignItems: 'center' }}>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                <Text style={{ fontWeight: '900', fontSize: 18, color: '#276653' }}>{weatherData.avgtemp_c}</Text>
                                                <Icon name={"thermometer"} color={'#276653'} size={23} style={{ width: 20 }} />
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ alignItems: 'center' }}>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                <Text style={{ fontWeight: '900', fontSize: 18, color: '#276653' }}>{weatherData.maxwind_kph}</Text>
                                        ...
                                        <View style={{ alignItems: 'center' }}>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                <Text style={{ fontWeight: '900', fontSize: 18, color: '#276653' }}>{weatherData.avghumidity}%</Text>
                        ...
                        <View style={styles.dashboardRecent}>
                            <Text style={{ fontSize: 18, fontWeight: 'bold' }}>Insect Pests and Diseases</Text>
